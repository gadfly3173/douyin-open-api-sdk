 ...
 * 获取授权码(code) 参数实体类
 */
public class OauthConnectParam extends BaseParam {
    /**
     * 填写code
     */
    ...
    public OauthConnectParam setResponseType(String responseType) {
    ...
    public OauthConnectParam setScope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public OauthConnectParam setRedirectUri(String redirectUri) {
