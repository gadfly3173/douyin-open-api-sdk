...
public class BaseVideo implements Serializable {
     ...
     * 视频统计
     */
    private VideoStatisticsBase statistics;
    ...
    public BaseVideo setVideoId(String videoId) {
    ...
    public BaseVideo setTitle(String title) {
        this.title = title;
        return this;
    }
    ...
    public BaseVideo setCover(String cover) {
        this.cover = cover;
        return this;
    }
    ...
    public BaseVideo setIsTop(String isTop) {
        this.isTop = isTop;
        return this;
    }
    ...
    public BaseVideo setCreateTime(Long createTime) {
    ...
    public BaseVideo setIsReviewed(String isReviewed) {
    ...
    public BaseVideo setShareUrl(String shareUrl) {
        this.shareUrl = shareUrl;
        return this;
    }

    public VideoStatisticsBase getStatistics() {
        return statistics;
    }

    public BaseVideo setStatistics(VideoStatisticsBase statistics) {
