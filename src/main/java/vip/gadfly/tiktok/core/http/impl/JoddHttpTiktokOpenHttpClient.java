 ...
 **/
@Slf4j
public class JoddHttpTiktokOpenHttpClient extends AbstractTiktokOpenHttpClient {

    public JoddHttpTiktokOpenHttpClient() {
        super(TiktokOpenJsonBuilder.instance());
    }

    public JoddHttpTiktokOpenHttpClient(JsonSerializer jsonSerializer) {
