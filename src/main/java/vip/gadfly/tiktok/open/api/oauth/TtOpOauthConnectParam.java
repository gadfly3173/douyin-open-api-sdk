 ...
 * 获取授权码(code) 参数实体类
 */
public class TtOpOauthConnectParam extends TtOpBaseParam {
    /**
     * 填写code
     */
    ...
    public TtOpOauthConnectParam setResponseType(String responseType) {
    ...
    public TtOpOauthConnectParam setScope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public TtOpOauthConnectParam setRedirectUri(String redirectUri) {
