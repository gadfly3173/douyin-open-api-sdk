 ...
 * 关注列表
 */
public class TtOpVideoUploadApi extends AbstractTtOpApiBase {
    public String VIDEO_UPLOAD = getHttpUrl() + "/video/upload/";

    /**
     * 上传文件到文件务器
     *
     * @param param TtOpVideoUploadParam
     * @return
     */
    public TtOpVideoUploadResult doPost(TtOpVideoUploadParam param) {
        String url = VIDEO_UPLOAD + "?" + param.getNoPageUrlParam();
        TtOpVideoUploadResult result = sendPost(url, param.getUploadFile(), param.getMediaType()).dataToBean(TtOpVideoUploadResult.class);
        return result;
    }
     ...
     * @return
     */
    public TtOpVideoUploadResult doPost(File uploadVideoFile, String videoMediaType) {
        //取缓存token
        String accessToken = getAccessToken();
        //拼接参数
        TtOpVideoUploadParam param = new TtOpVideoUploadParam();
     ...
     * @return
     */
    public TtOpVideoUploadResult doPost(String videoDir, String videoMediaType) {
    ...
    public TtOpVideoUploadApi withAccessToken(String accessToken) {
        setAccessToken(accessToken);
        return this;
    }

    public TtOpVideoUploadApi withOpenId(String openId) {
        setOpenId(openId);
        return this;
    }
