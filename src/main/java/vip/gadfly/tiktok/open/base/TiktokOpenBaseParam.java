...
public class TiktokOpenBaseParam implements Serializable {
    ...
    public TiktokOpenBaseParam setAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public TiktokOpenBaseParam setAppSecret(String appSecret) {
    ...
    public TiktokOpenBaseParam setOpenId(String openId) {
        this.openId = openId;
        return this;
    }
    ...
    public TiktokOpenBaseParam setAccessToken(String accessToken) {
    ...
    public TiktokOpenBaseParam setCursor(Long cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public TiktokOpenBaseParam setCount(Long count) {
        this.count = count;
        return this;
    }
