...
import vip.gadfly.tiktok.open.api.user.TtOpOauthUserInfoResult;
import vip.gadfly.tiktok.open.common.TtOpBaseParam;

import java.util.List;

public class TtOpVideoCreateParam extends TtOpBaseParam {
    ...
    private List<TtOpOauthUserInfoResult> atUsers;
    ...
    public TtOpVideoCreateParam setVideoId(String videoId) {
    ...
    public TtOpVideoCreateParam setText(String text) {
        this.text = text;
        return this;
    }
    ...
    public TtOpVideoCreateParam setPoiId(String poiId) {
        this.poiId = poiId;
        return this;
    }
    ...
    public TtOpVideoCreateParam setPoiName(String poiName) {
    ...
    public TtOpVideoCreateParam setMicroAppId(String microAppId) {
    ...
    public TtOpVideoCreateParam setMicroAppTitle(String microAppTitle) {
    ...
    public TtOpVideoCreateParam setMicroAppUrl(String microAppUrl) {
    ...
    public TtOpVideoCreateParam setCoverTsp(Double coverTsp) {
        this.coverTsp = coverTsp;
        return this;
    }

    public List<TtOpOauthUserInfoResult> getAtUsers() {
        return atUsers;
    }

    public TtOpVideoCreateParam setAtUsers(List<TtOpOauthUserInfoResult> atUsers) {
