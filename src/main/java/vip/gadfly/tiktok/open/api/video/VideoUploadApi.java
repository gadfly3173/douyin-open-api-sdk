...
public class VideoUploadApi extends ApiBase {
     ...
     * @return
     */
    public VideoUploadResult doPost(File uploadVideoFile, String videoMediaType) {
        //取缓存token
        String accessToken = getAccessToken();
        //拼接参数
        VideoUploadParam param = new VideoUploadParam();
     ...
     * @return
     */
    public VideoUploadResult doPost(String videoDir, String videoMediaType) {
    ...
    public VideoUploadApi withAccessToken(String accessToken) {
        setAccessToken(accessToken);
        return this;
    }

    public VideoUploadApi withOpenId(String openId) {
        setOpenId(openId);
        return this;
    }
